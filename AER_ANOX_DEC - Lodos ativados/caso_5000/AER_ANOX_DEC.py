...
#ax2 = ax1.twinx()
ax2.plot(x_axie, processo_aer_df['H_grow'], label='Crescimento_BH', color='green', linestyle=':', linewidth=3)
#ax2.plot(x_axie, processo_aer_df['Han_grow'], label='Crescimento_BHanox', color='red', linestyle=':', linewidth=3)
ax2.plot(x_axie, processo_aer_df['decay_H'], label='Decaimento_BH', color='black', linestyle=':', linewidth=3)
ax2.plot(x_axie, processo_aer_df['hydro_org'], label='Hidrólise-DQO', color='purple', linestyle=':', linewidth=3)
ax2.set_ylabel('Processo (g/(m³*s))')
...
#ax1.legend(loc='upper right', framealpha = 1)
#ax2 = ax1.twinx()
ax2.plot(x_axie, processo_aer_df['A_grow'], label='Crescimento_BA', color='green', linestyle=':', linewidth=3)
ax2.plot(x_axie, processo_aer_df['Ammonia'], label='Amonificação', color='red', linestyle=':', linewidth=3)
ax2.plot(x_axie, processo_aer_df['hydro_N'], label='Hidrólise-N', color='purple', linestyle=':', linewidth=3)
ax2.set_ylabel('Processo (g/(m³*s))')
ax1.legend(loc='upper right', framealpha = 1)
ax2.legend(loc='center right', framealpha = 1)
plt.tight_layout()
...
#FIGURA 3 CONSUMO NO
fig, ax1 = plt.subplots()
ax1.plot(x_axie, plot_list_an['X_BH'], label='X_BH', color='blue', linestyle='-', linewidth=3)
...
ax1.legend(loc='upper right', framealpha = 1)
ax2 = ax1.twinx()
ax2.plot(x_axie, processo_an_df['Han_grow'], label='Crescimento_BHanox', color='blue', linestyle=':', linewidth=3)
...
ax2.plot(x_axie, processo_an_df['decay_H'], label='Decaimento_BH', color='black', linestyle=':', linewidth=3)
ax2.set_ylabel('Processo (g/(m³*s))')
ax2.legend(loc='center right', framealpha = 1)
plt.tight_layout()
plt.show()
